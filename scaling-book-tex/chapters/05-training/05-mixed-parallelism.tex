...
{\footnotesize
\begin{tcolorbox}[algorithmbox, title=Algorithm: Combining FSDP and Tensor Parallelism]
...
\begin{tcolorbox}[takeawaybox]
Combining tensor parallelism with FSDP allows us to drop to a~$B/N$ of $2550^2 / 2F$. This lets us handle a batch of as little as~100 per chip, which is roughly a factor of eight smaller than we could achieve with just FSDP.
\end{tcolorbox}
