...
\begin{itemize}
\item Increasing parallelism or reducing batch size both tend to make us more communication-bound because they reduce the amount of compute performed per device.
...
\item Data parallelism and FSDP become comms bound when the per-device batch size $< C / W$, the arithmetic intensity of the network. For ICI this is~2,550 and for DCN this is~75,000. This can be increased with more parallel axes.
