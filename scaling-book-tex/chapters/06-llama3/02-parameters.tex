...
\midrule
FFW params & d\_model * d\_ff * 3 (for gelu + out-projection) * n\_layers & 8,192 * 8,192 * 3.5 * 3 * 80 = \textbf{56.3e9} \\
\addlinespace
Vocab params & 2 (input and output embeddings) * n\_embeddings * d\_model & 2 * 128,256 * 8,192 = \textbf{2.1e9} \\
\addlinespace
Attention params & n\_layers * [ 2 (for q embedding and concatenated output projection) * d\_model * n\_heads * d\_qkv + 2 (for k and v) * d\_model * n\_kv\_heads * d\_qkv] & 80 * (2 * 8,192 * 64 * 128 + 2 * 8,192 * 8 * 128) = \textbf{12e9} \\
\addlinespace
