...
\begin{align*}
\small
&\text{\small Theoretical Step Time (General)} = \underbrace{\frac{\text{\small Batch Size} \times \text{KV Cache Size}}{\text{Total Memory Bandwidth}}}_{\text{\small Attention (always bandwidth-bound)}} \\
& + \underbrace{\max\left(\frac{2 \times \text{\tiny Batch Size} \times \text{\tiny Parameter Count}}{\text{\tiny Total FLOPs/s}}, \frac{\text{\tiny Parameter Size}}{\text{\tiny Total Memory Bandwidth}}\right)}_{\text{\tiny MLP (can be compute-bound)}}
\end{align*}
