...
\caption{\textbf{Left:} Multiple layers of pure global attention. \textbf{Right:} An example of some global/local interleaving pattern with sharing with adjacent layers. Source: \href{https://research.character.ai/optimizing-inference/?ref=blog.character.ai}{Character.ai blog}.}
\end{figure}
