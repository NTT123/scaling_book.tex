...
\begin{takeawaybox}
The maximum amount of useful model parallelism depends on $d_{ff}$ and the number of axes over which you're sharding your model. The maximum value usually ranges between 8 and 32 depending on the model size. You can scale beyond this limit to improve latency at some throughput cost.
\end{takeawaybox}
