...
\begin{takeawaybox}
\textbf{Tip:} you can navigate the Trace Viewer using ``video game'' style controls, with A/D panning left and right, and W/S zooming in and out. These controls make navigating a lot easier.
\end{takeawaybox}
